...
- [[Engineering Philosophy/Principles/Layered Risk Categories]] — Engineering risk splits into six layers — specification, type model, runtime, concurrency, deployment, supply chain — and a control either mitigates one or it is decoration.
