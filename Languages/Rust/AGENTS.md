...
- **Wiring an optimized algorithm (GPU, SIMD, parallel, WASM)** → [[Engineering Philosophy/Principles/Reference Implementation as Oracle]]; [[Languages/Rust/Workspace/Patterns/Reference Path Cargo Wiring]]; [[Engineering Philosophy/Principles/Sharp Oracles]]; [[Languages/Rust/Practices/Effect Isolation/Pure Core Effectful Edges]]; [[Integration/Rust-WASM-TS/Decision and Architecture/When Rust-WASM Is Justified]]; [[Integration/Rust-WASM-TS/Decision and Architecture/TypeScript Shell Rust Kernel Architecture]]
